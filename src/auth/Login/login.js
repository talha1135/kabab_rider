...
import {Blue, Pink, Grey, LightGrey, Brown, Cream, Orange,LightBlue} from '../../utils/Constants';
...
export default class Login extends Component {
  ...
  onLoginPress = () => {
        if(this.state.email != null && this.state.password != null){
          ...
          Caller.callServer("LoginRider","POST", [this.state.email,this.state.password])
              .then( response  => {
              ...
              .then ( data => {
                if(data.message == 'login successfuly'){
                  ...
                  const rider=JSON.stringify(data.Data);
                  AsyncStorage.setItem('rider', rider)
                  .catch(err => {
                    console.log(err);
                  })
